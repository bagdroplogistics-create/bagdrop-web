...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.bagdrop.co'),
  title: {
        ...
        <Script id="schema-website" type="application/ld+json" strategy="beforeInteractive">
          {JSON.stringify({
            ...
            'potentialAction': {
              ...
              'target': {
                '@type': 'EntryPoint',
                'urlTemplate': 'https://www.bagdrop.co/track?id={search_term_string}',
              },
        ...
        <Script id="schema-org" type="application/ld+json" strategy="beforeInteractive">
          {JSON.stringify({
            ...
            '@graph': [
              ...
              {
                '@type': 'Organization',
                '@id': 'https://www.bagdrop.co/#organization',
                'name': 'Bagdrop Logistics Solutions Pvt. Ltd.',
                'alternateName': 'Bagdrop',
                'url': 'https://www.bagdrop.co',
                'logo': {
                  '@type': 'ImageObject',
                  'url': 'https://www.bagdrop.co/logo.png',
                  'width': 200,
                  'height': 60,
                },
                'image': 'https://www.bagdrop.co/og-image.jpg',
              ...
              {
                '@type': 'LocalBusiness',
                '@id': 'https://www.bagdrop.co/#business',
                ...
                'telephone': '+91-63-5711-5711',
                'email': 'info@bagdrop.co',
                'logo': 'https://www.bagdrop.co/logo.png',
                'image': 'https://www.bagdrop.co/og-image.jpg',
                'parentOrganization': { '@id': 'https://www.bagdrop.co/#organization' },
                'address': {
                  '@type': 'PostalAddress',
                  'streetAddress': 'TF-302, Ananta Stallion, Gotri Sevasi Road',
                  'addressLocality': 'Vadodara',
              ...
              {
                '@type': 'Service',
                '@id': 'https://www.bagdrop.co/excess-baggage#service',
                ...
                'provider': { '@id': 'https://www.bagdrop.co/#business' },
              ...
              {
                '@type': 'Service',
                '@id': 'https://www.bagdrop.co/airport-delivery#service',
              ...
              {
                '@type': 'Service',
                '@id': 'https://www.bagdrop.co/door-to-door#service',
                ...
                'url': 'https://www.bagdrop.co/door-to-door',
                'offers': { '@type': 'Offer', 'priceCurrency': 'INR', 'availability': 'https://schema.org/InStock' },
              },
              {
                '@type': 'Service',
                '@id': 'https://www.bagdrop.co/destination-weddings#service',
                ...
                'provider': { '@id': 'https://www.bagdrop.co/#business' },
                'areaServed': { '@type': 'Country', 'name': 'India' },
                'url': 'https://www.bagdrop.co/destination-weddings',
                'offers': { '@type': 'Offer', 'priceCurrency': 'INR', 'availability': 'https://schema.org/InStock' },
              },
              {
                '@type': 'Service',
                '@id': 'https://www.bagdrop.co/student-relocation#service',
                ...
                'provider': { '@id': 'https://www.bagdrop.co/#business' },
                'areaServed': { '@type': 'Country', 'name': 'India' },
                'url': 'https://www.bagdrop.co/student-relocation',
                'offers': { '@type': 'Offer', 'priceCurrency': 'INR', 'availability': 'https://schema.org/InStock' },
              },
              {
                '@type': 'Service',
                '@id': 'https://www.bagdrop.co/corporate-travel#service',
                ...
                'provider': { '@id': 'https://www.bagdrop.co/#business' },
                'areaServed': { '@type': 'Country', 'name': 'India' },
                'url': 'https://www.bagdrop.co/corporate-travel',
                'offers': { '@type': 'Offer', 'priceCurrency': 'INR', 'availability': 'https://schema.org/InStock' },
              },

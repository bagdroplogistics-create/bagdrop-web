...
export const metadata: Metadata = {
  title: 'Door-to-Door Luggage Delivery — Bagdrop',
  description: 'Ship your bags between any two addresses across Gujarat, Maharashtra, and Goa. Reliable intercity luggage delivery.',
}
  ...
  return (
    <ServicePage
      ...
      benefits={[
        ...
        { title: 'Live tracking', desc: 'Every intercity shipment comes with a real-time tracking link.' },
      ...
      faqs={[
        ...
        { q: 'Can someone else receive the bags?', a: 'Yes. Just provide the recipient name and phone at booking. They will receive a tracking link and delivery notification.' },

...
export const metadata: Metadata = {
  title: 'Destination Wedding Baggage — Bagdrop',
  description: 'White-glove baggage logistics for destination weddings across India.',
}
  ...
  return (
    <ServicePage
      ...
      benefits={[
        ...
        { title: 'Multi-city coordination', desc: 'Pickup from multiple family homes across different cities. Single booking. One tracking dashboard.' },

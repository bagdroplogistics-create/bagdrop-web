...
const FAQS = [
  {
    ...
    items: [
      ...
      { q: 'Can I change or cancel my booking?', a: 'Yes. Contact us on WhatsApp to change or cancel your booking. For a full refund, cancellations must be made at least 7 days before the scheduled pick-up time — for all destinations.' },

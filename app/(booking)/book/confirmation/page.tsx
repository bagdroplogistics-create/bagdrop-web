...
import { CheckCircle2, Package, ArrowRight, MessageCircle, Mail } from 'lucide-react'
  ...
  return (
    <main className="min-h-screen bg-cream pt-20 pb-24">
      <div className="mx-auto max-w-xl px-4 sm:px-6 py-16 text-center">
        ...
        >
          ...
          {trackingId && (
            <div className="mt-6 inline-flex items-center gap-2 rounded-xl bg-white border border-border px-5 py-3 shadow-sm">
              ...
              <span className="text-sm text-text-muted">Your Booking ID:</span>
        ...
        >
          <h2 className="font-display text-sm font-semibold text-text-primary">What happens next?</h2>
          {[
        ...
        <p className="mt-8 text-xs text-text-muted">
          <Link href="/" className="underline underline-offset-4 hover:text-brand">
            ← Back to home
          </Link>
        </p>
      </div>
